...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        ...
        This method returns a dictionary containing the information needed for
        hypermedia pagination.

        Args:
            index (int, optional): The current start index of the return page.
            If not provided (or None),
                it will start from the beginning (index 0). Defaults to None.
        ...
        Returns:
            dict: A dictionary containing the following key-value pairs:
                ...
                - "next_index": The next index to query with. None if the
